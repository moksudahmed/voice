...
# CONFIG
# ---------------------------------------
CREX_URL = "https://crex.com/cricket-live-score/ban-vs-pak-1st-test-pakistan-tour-of-bangladesh-2026-match-updates-11PM"
OUTPUT_FILE = "C:/cricket_voices/score.json"
TEAM1 = "বাংলাদেশ  " 
TEAM2 = "পাকিস্তান"
match_title = "পাকিস্তান বনাম বাংলাদেশ ২০২৬"
...
welcome_msg2 = """
🔴🏏**🔴🏏 স্বাগতম লাইভ কমেন্টারিতে! Bangladesh vs Pakistan | ১ম টেস্ট | Bangladesh vs Pakistan 2026

হ্যালো ক্রিকেটপ্রেমীরা! 👋
আপনাদের সবাইকে স্বাগতম বাংলাদেশ বনাম পাকিস্তান সিরিজের বহুল প্রতীক্ষিত ১ম টেস্ট ম্যাচে। আজ মুখোমুখি হয়েছে দুই শক্তিশালী এশিয়ান ক্রিকেট দল—Bangladesh এবং Pakistan।

টেস্ট ক্রিকেট মানেই ধৈর্য, ট্যাকটিক্স, লম্বা ইনিংস এবং সেশন বাই সেশন উত্তেজনাপূর্ণ লড়াই। পাঁচ দিনের এই ক্লাসিক ফরম্যাটে প্রতিটি বল, প্রতিটি পার্টনারশিপ এবং প্রতিটি উইকেট ম্যাচের মোড় ঘুরিয়ে দিতে পারে।

🔥 TOSS UPDATE:
Pakistan টস জিতে প্রথমে বোলিং করার সিদ্ধান্ত নিয়েছে।
অর্থাৎ আজ Bangladesh প্রথমে ব্যাট করবে এবং বড় সংগ্রহ গড়ে ম্যাচে শক্ত অবস্থান নেওয়ার লক্ষ্য নিয়ে মাঠে নামছে।

⚡ এখন দেখার বিষয়, Bangladesh-এর টপ অর্ডার কতটা শক্তিশালী শুরু করতে পারে, নাকি Pakistan-এর ভয়ংকর পেস ও স্পিন আক্রমণ শুরু থেকেই চাপ তৈরি করবে!

🏏 আজকের টেস্ট ম্যাচে নজর থাকবে:
✅ দীর্ঘ ইনিংস ও গুরুত্বপূর্ণ পার্টনারশিপে
✅ পেস ও স্পিন বোলারদের ট্যাকটিক্যাল লড়াইয়ে
✅ সেশন বাই সেশন ম্যাচের পরিবর্তনে
✅ ব্যাটারদের ধৈর্য ও ডিফেন্সিভ টেকনিকে
✅ নতুন বল ও পুরোনো বলের ব্যবহারে

🎙️ আমরা আপনাদের জন্য নিয়ে এসেছি:
✅ বল বাই বল লাইভ আপডেট
✅ রিয়েল টাইম স্কোরকার্ড
✅ বাংলা ও হিন্দি কমেন্টারি
✅ ম্যাচ বিশ্লেষণ ও গুরুত্বপূর্ণ মুহূর্তের আলোচনা

📌 পুরো টেস্ট ম্যাচ জুড়ে আমাদের সাথে থাকুন এবং উপভোগ করুন Bangladesh vs Pakistan ১ম টেস্ট ২০২৬ এর প্রতিটি রোমাঞ্চকর মুহূর্ত!
                    ...
                    if "Live" in current_status:
                        ...
                        if last_status_message and message != last_status_message:
                            ...
                            if last_status_message == "Ball":  
                                ...
                                print(commentary)
                                speak("STRATEGIC_TIMEOUT",commentary)
