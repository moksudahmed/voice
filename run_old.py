...
# CONFIG
# ---------------------------------------
CREX_URL = "https://crex.com/cricket-live-score/kkr-vs-lsg-38th-match-indian-premier-league-2026-match-updates-118J"
OUTPUT_FILE = "C:/cricket_voices/score.json"
TEAM1 = "Kolkata Knight Riders" 
TEAM2 = "Lucknow Super Giants"
match_title = "KKR vs LSG, 38th T20, IPL 2026 live"
...
welcome_msg = """স্বাগতম সবাইকে আজকের হাই-ভোল্টেজ ম্যাচে! 🏏
কলকাতা নাইট রাইডার্স 🆚 লখনউ সুপার জায়ান্টস — আইপিএল ২০২৬ এর ৩৮তম ম্যাচে আপনাদের সবাইকে জানাই আন্তরিক শুভেচ্ছা।

🔥 টস আপডেট:
লখনউ সুপার জায়ান্টস টসে জিতে প্রথমে বোলিং করার সিদ্ধান্ত নিয়েছে।

📢 গেম আপডেট:
ম্যাচ শুরু হয়ে গেছে, কলকাতা নাইট রাইডার্স ব্যাটিংয়ে নেমেছে! ওপেনাররা সতর্কভাবে ইনিংস গড়ার চেষ্টা করছে, আর লখনউর বোলাররা শুরু থেকেই চাপ তৈরি করতে চাইছে। পাওয়ারপ্লের এই সময়টা খুবই গুরুত্বপূর্ণ—এখানেই ম্যাচের টোন সেট হয়ে যেতে পারে!

👀 এখন দেখার বিষয়, KKR কি বড় স্কোর দাঁড় করাতে পারে, নাকি LSG শুরুতেই উইকেট তুলে ম্যাচে নিয়ন্ত্রণ নিয়ে নেয়!

📊 আমাদের সাথে থাকুন লাইভ স্কোর, বল বাই বল আপডেট এবং একদম রিয়েল-টাইম বাংলা কমেন্ট্রির জন্য!
"""
