...
# CONFIG
# ---------------------------------------
CREX_URL = "https://crex.com/cricket-live-score/csk-vs-dc-48th-match-indian-premier-league-2026-match-updates-118T"
OUTPUT_FILE = "C:/cricket_voices/score.json"
TEAM1 = "দিল্লি ক্যাপিটালস  " 
TEAM2 = "চেন্নাই সুপার কিংস"
match_title = "চেন্নাই সুপার কিংস বনাম দিল্লি ক্যাপিটালস"
...
welcome_msg2 = """
🔴🏏 **স্বাগতম লাইভ কমেন্টারিতে!চেন্নাই সুপার কিংস বনাম দিল্লি ক্যাপিটালস | আইপিএল 2026 | ৪৮ তম  টি টোয়েন্টি  ম্যাচ**

নমস্কার ক্রিকেটপ্রেমীরা! 👋
আপনাদের সবাইকে স্বাগতম আজকের এই রোমাঞ্চকর ম্যাচে—চেন্নাই সুপার কিংস বনাম দিল্লি ক্যাপিটালস, আইপিএল 2026-এর ৪৮তম  টি টোয়েন্টি  লড়াইয়ে।

আজকের ম্যাচে দুই শক্তিশালী দল মুখোমুখি হয়েছে, তাই শুরু থেকেই থাকছে হাই-ভোল্টেজ ক্রিকেট অ্যাকশন!

🔥 **TOSS UPDATE:**
দিল্লি ক্যাপিটালস টস জিতে প্রথমে **ব্যাটিং করার সিদ্ধান্ত নিয়েছে**।
অর্থাৎ আজ দিল্লি ক্যাপিটালস আগে ব্যাট করবে এবং একটি বড় স্কোর গড়ে চেন্নাই সুপার কিংস-কে চাপে ফেলার লক্ষ্য নিয়ে মাঠে নামছে।

⚡ এখন দেখার বিষয়, দিল্লি ক্যাপিটালস-এর ব্যাটিং লাইনআপ কতটা শক্তিশালী শুরু করতে পারে, নাকি চেন্নাই সুপার কিংস-এর বোলাররা শুরুতেই ম্যাচের নিয়ন্ত্রণ নিয়ে নেয়!
...
📌 পুরো ম্যাচ জুড়ে আমাদের সাথে থাকুন এবং উপভোগ করুন **Chennai Super Kings vs Delhi Capitals** এই হাই-ভোল্টেজ লড়াইয়ের প্রতিটি মুহূর্ত!
