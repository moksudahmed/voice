...
TEAM1 = "রাজস্থান রয়্যালস" 
TEAM2 = "দিল্লি ক্যাপিটালস"
match_title = "দিল্লি ক্যাপিটালস বনাম রাজস্থান রয়্যালস "
...
welcome_msg = """
স্বাগতম লাইভ কমেন্টারিতে! DC vs RR | IPL 2026 | ৪৩তম T20 ম্যাচ

হ্যালো ক্রিকেটপ্রেমীরা! 👋
আপনাদের সবাইকে স্বাগতম আজকের এই রোমাঞ্চকর ম্যাচে—Delhi Capitals বনাম Rajasthan Royals, IPL 2026-এর ৪৩তম  T20 লড়াইয়ে।

আজকের ম্যাচটি হতে যাচ্ছে দারুণ প্রতিদ্বন্দ্বিতাপূর্ণ! দুই দলই শক্তিশালী স্কোয়াড নিয়ে মাঠে নামছে, তাই শুরু থেকেই জমে উঠবে ম্যাচের উত্তেজনা।

🔥 TOSS UPDATE:
Rajasthan Royals টস জিতে প্রথমে ব্যাটিং করার সিদ্ধান্ত নিয়েছে।
অর্থাৎ আজ RR আগে ব্যাট করবে এবং বড় একটি স্কোর গড়ে তোলার চেষ্টা করবে, আর DC বোলিং দিয়ে শুরু করবে।

⚡ এখন দেখার বিষয়, RR ব্যাটিং লাইনআপ কতটা শক্তিশালী শুরু করতে পারে, নাকি DC বোলাররা শুরুতেই ম্যাচের নিয়ন্ত্রণ নিজেদের হাতে নিয়ে নেবে!
...
📌 পুরো ম্যাচ জুড়ে আমাদের সাথে থাকুন, DC vs RR এই হাই-ভোল্টেজ ম্যাচের প্রতিটি মুহূর্ত উপভোগ করুন!
"""
